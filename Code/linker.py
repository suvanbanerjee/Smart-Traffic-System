...
it.start()
signal_1_red = board.get_pin('d:11:o')
signal_1_yellow = board.get_pin('d:12:o')
signal_1_green = board.get_pin('d:13:o')
signal_2_red = board.get_pin('d:8:o')
signal_2_yellow = board.get_pin('d:9:o')
signal_2_green = board.get_pin('d:10:o')
signal_3_red = board.get_pin('d:5:o')
signal_3_yellow = board.get_pin('d:6:o')
signal_3_green = board.get_pin('d:7:o')
signal_4_red = board.get_pin('d:2:o')
signal_4_yellow = board.get_pin('d:3:o')
signal_4_green = board.get_pin('d:4:o')
